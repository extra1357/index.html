...
PROJECT_DIR="$(pwd)"
echo "📁 Corrigindo filtro de status em: $PROJECT_DIR"
echo ""

# ─────────────────────────────────────────────
# 1. src/app/imoveis-publicos/page.tsx
# ─────────────────────────────────────────────
...
EOF
echo "✅ src/app/imoveis-publicos/page.tsx"

# ─────────────────────────────────────────────
# 2. src/app/imoveis-salto/page.tsx — corrige getImoveisSalto e getEstatisticas
# ─────────────────────────────────────────────
sed -i "s/status: 'ATIVO',/status: { in: ['ATIVO', 'ALUGADO'] },/g" "$PROJECT_DIR/src/app/imoveis-salto/page.tsx"
echo "✅ src/app/imoveis-salto/page.tsx (filtro de status corrigido)"
